/* groovylint-disable CompileStatic, CouldBeSwitchStatement, DuplicateStringLiteral, LineLength, NoDef, VariableName, VariableTypeRequired */
properties([
    parameters([
...
node {
    stage('Pull Repo') {
        cleanWs()
        git url: 'https://github.com/nargiza777/terraform-vpc.git'
    }
